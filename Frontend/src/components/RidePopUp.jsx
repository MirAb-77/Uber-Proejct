...
const RidePopUp = (props) => {
    ...
    const handleClose = () => {
        setIsClosing(true);
        setTimeout(() => props.setRidePopupPanel(false), 100);
    };
            ...
            <div className='flex items-center justify-between p-5 bg-black rounded-lg mt-5 shadow-md'>
                <div className='flex items-center gap-4'>
                    <img className='h-20 w-20 rounded-full object-cover' 
                         src="https://png.pngtree.com/png-clipart/20230409/original/pngtree-handsome-man-is-smiling-png-image_9039601.png" 
                         alt="User" />
            ...
            <div className='mt-5 space-y-4'>
                <div className='flex items-center gap-4 p-3 bg-gray-200 rounded-lg shadow-sm'>
                    ...
                    <div>
                        ...
                        <p className='text-md text-gray-700'>{props.ride?.pickup || "N/A"}</p>
                    </div>
                </div>
                <div className='flex items-center gap-4 p-3 bg-gray-200 rounded-lg shadow-sm'>
                    ...
                    <div>
                        ...
                        <p className='text-md text-gray-700'>{props.ride?.destination || "N/A"}</p>
                    </div>
                </div>
